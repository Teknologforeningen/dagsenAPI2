...
class APIClient:
    ...
    def make_request(self, endpoint, retry=True):
            ...
            try:
                ...
                print(f"API request failed: {e} status: {response.status_code}") #FIXME: change to return error instead of printing
                return None
            except PermissionError as pe:
                print(f"API request failed: {pe} status: {response.status_code}") #FIXME: change to return error instead of printing
                return None
